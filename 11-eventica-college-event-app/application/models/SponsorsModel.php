...
class SponsorsModel extends CI_Model {
  ...
  public function fetch($params)
  {
    ...
    # sponsors_id
    if(isset($params['sponsors_id']) && strlen($params['sponsors_id']) > 0) $this->db->where('sponsors_id', $params['sponsors_id']);
  ...
  public function create(array $input)
  {
    # Create array
    $data=array(
      'sponsor_company_name'=>$input['sponsor_company_name'],
      'sponsor_web_url'=>$input['sponsor_web_url'],
      'sponsor_company_address'=>$input['sponsor_company_address'],
