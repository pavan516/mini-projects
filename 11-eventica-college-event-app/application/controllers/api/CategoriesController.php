...
class CategoriesController extends REST_Controller
{
  ...
  public function create_post()
  {
    ...
    # category_name exist check
    if(empty($input['category_name'])) {
      return $this->set_response(['status'=>'fail', 'code'=>'0', 'message'=>'Bad Request', 'details'=>'category_name is a mandatory field'], REST_Controller::HTTP_BAD_REQUEST);
    }

    # Send request to model - returns an array
    $result=$this->CategoriesModel->create($input);
  ...
  public function update_put(int $id)
  {
    ...
    # Send request to model - returns an array
    $result=$this->CategoriesModel->update($id, $input);
