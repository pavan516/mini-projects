 ...
 * Stalls Controller
 */
class StallsController extends REST_Controller
{
  # Construct the parent class
  public function __construct() {
    parent::__construct();
    # Load model
    $this->load->model('StallsModel');
  ...
  public function create_post()
  {
    ...
    # stall_name exist check
    if(empty($input['stall_name'])) {
      return $this->set_response(['status'=>'fail', 'code'=>'0', 'message'=>'Bad Request', 'details'=>'stall_name is a mandatory field'], REST_Controller::HTTP_BAD_REQUEST);
    }
    
    # event_id exist check
    if(empty($input['event_id'])) {
      return $this->set_response(['status'=>'fail', 'code'=>'0', 'message'=>'Bad Request', 'details'=>'event_id is a mandatory field'], REST_Controller::HTTP_BAD_REQUEST);
    }

    # Send request to model - returns an array
    $result=$this->StallsModel->create($input);
  ...
  public function update_put(int $id)
  {
    ...
    # Send request to model - returns an array
    $result=$this->StallsModel->update($id, $input);
  ...
  public function delete_delete(int $id)
  {
    ...
    $result = $this->StallsModel->delete($id);
