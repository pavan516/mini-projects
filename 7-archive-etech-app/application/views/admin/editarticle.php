          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="card mb-4 wow fadeIn">
                <h2 style="text-align:center;color:blue;margin-top:7px;"><b>Edit Article</b></h2>
              </div>
              <!-- Heading -->

              <!-- Form -->
              <div class="basic-form">
                <form action="<?php echo base_url();?>admin/article/update/<?php echo $item['id']; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div style="text-align:center;">
                    ...
                    <a type="button" class="btn btn-primary" href="<?php echo base_url();?>admin/articles">Cancel</a>
                  </div>
                  <!-- Update Button -->
