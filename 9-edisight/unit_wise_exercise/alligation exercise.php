          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="unit_wise_exercise/index.html">Topic Wise Exercise</a></li>
...
<div class="scp-quizzes-data">
  <h3>1. What is the full form of pk?</h3>
...
<br/>
 ...
 <div class="scp-quizzes-data">
  <h3>2. What is the full form of pk?</h3>
    
<br/>
    <input type="radio" id="Fast" name="question3">
       <label for="Fast">1. Fast</label><br/>
    <input type="radio"  name="question1">
       <label>2. learning</label><br/>
    <input type="radio" name="question1">
       <label>3. learningFast</label> <br/>
 ...
 <div class="scp-quizzes-data">
  <h3>3. How would you insert pre-written code into a current program ?</h3>
...
<br/>
 ...
 <div class="scp-quizzes-data">
  <h3>4. How would you insert pre-written code into a current program ?</h3>
...
<br/>
    ...
    <input type="radio"  name="question2">
       <label>2. #get &lt;file></label><br/>
    <input type="radio" name="question2" id="inculd">
       <label for="inculd">3. #include &lt;file></label> <br/>
    <input type="radio" name="question2">
     <label>4. #pre &lt;file></label> 
 </div>
