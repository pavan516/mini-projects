          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="card mb-4 wow fadeIn" style="margin-bottom: 0rem !important;">
                <h2 class="input-default" style="text-align:center;background-color:blue;color:white;padding:10px;font-size:20px"><b>ADD DELIVERY BOY</b></h2>
              </div>
              <!-- Heading -->
              ...
              <div class="basic-form">
                <form action="<?php echo base_url();?>deliveryboy/insert" method="post" enctype="multipart/form-data">

                  <!-- name & email -->
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label>User Name</label>
                      <input type="text" name="name" id="name" class="form-control" placeholder="Deliver Boy Name - Must be unique To Identify" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Email</label>
                      <input type="email" name="email" id="email" class="form-control" placeholder="Email Of The Delivery Boy" required>
                    </div>
                  </div>
                  <!-- name & email -->
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="mobile" id="mobile" class="form-control" placeholder="Delivery Boy Working Mobile Number" required>
                    </div>
                    <div class="form-group col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="address" id="address" class="form-control" placeholder="REQUIRED FULL ADDRESS OF DELIVERY BOY" required></textarea>
                  </div>
                  <!-- address -->
