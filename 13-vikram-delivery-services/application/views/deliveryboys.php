            ...
            <div class="card">
              <div class="card-body" style="padding: 0.5rem 0.5rem;">
                ...
                <div class="card mb-4 wow fadeIn" style="margin-bottom: 0rem !important;">
                  <h2 class="input-default" style="text-align:center;background-color:blue;color:white;padding:10px;font-size:20px"><b>DELIVERY BOYS</b></h2>
                </div>
                <!-- Heading -->
                    ...
                    if(!empty($items)) {
                      ...
                      foreach($items as $item) {
                        echo "<tr style='text-align:center'>";
                          ...
                          if(!empty($item['image'])) {
                            echo "<td><img src='".$item['image']."' alt='Image Missing' width='50' height='50'></td>";
                          } else {
                          ...
                          <td style='word-wrap:break-word;max-width:160px;'>
                            <a href="<?php echo base_url();?>deliveryboy/delete/<?php echo $item['uuid']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>&nbsp
                            <a href="<?php echo base_url();?>deliveryboy/view/<?php echo $item['uuid']; ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                          </td>
                        <?php echo "</tr>";
                        $count++;
                      }
