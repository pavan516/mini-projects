<!DOCTYPE html>
  ...
  <head>
    ...
    <!-- Title -->
    <title itemprop="name">REGISTRATION - VIKRAM DELIVERY SERVICES</title>
            ...
            <div class="form-input-content">
              <div class="card login-form mb-0">
                <div class="card-body pt-5">
                  ...
                  <!-- Form -->
                  <form class="mt-5 mb-5 login-input" action="<?php echo base_url();?>auth/insert/user" method="POST" enctype="multipart/form-data">
                  ...
                  <p class="mt-5 login-form__footer">
                    Already Have account? | <a href="<?php echo base_url();?>auth/login" class="text-primary"><b>Sign In Here</b></a></p>
                  </p>
