                      ...
                      foreach($items as $item) {
                        echo "<tr style='text-align:center'>";
                          ...
                          if($item['verified']==1) {
                            ...
                            echo '<td><a href="'.base_url().'auth/forceverify/user/'.$item['uuid'].'" class="btn btn-primary"><i class="fa fa-unlock"></i></a></td>';
                          }
                          echo "<td>".$item['otp']."</td>";?>
                          <td style='word-wrap:break-word;max-width:160px;'>
                            <a href="<?php echo base_url();?>user/view/<?php echo $item['uuid']; ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
                          </td>
                        <?php echo "</tr>";
                        $count++;
                      }
