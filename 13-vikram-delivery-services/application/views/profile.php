              ...
              <div class="card-body">
                <div class="media align-items-center mb-4">
                  <?php if(!empty($item['image'])) { ?>
                    <img class="mr-3" src="<?php echo $item['image']; ?>" width="80" height="80" alt="">
                  <?php } else { ?>
                  ...
                  <div class="media-body">
                    ...
                    <?php } else if($this->session->userdata('role')=="DELIVERY_BOYS") {?>
                      <p class="text-muted mb-0"> <?php echo $item['role']; ?></p>
                    <?php } else {?>
                ...
                <?php if($this->session->userdata('role')=="USERS") {?>
                  <hr><p class="text-muted">You Joined VDS ON : <b><?php echo $item['created_dt']; ?></b></p>
                <?php }?>
                <?php if($this->session->userdata('role')=="DELIVERY_BOYS") {?>
          ...
          <div class="col-lg-8 col-xl-9">
            <div class="card">
              <div class="card-body">
                ...
                <form action="<?php echo base_url();?>auth/change/password" method="post" enctype="multipart/form-data">
