          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body" style="padding: 0.5rem 0.5rem;">
                ...
                <!-- Search form -->
                <form action="<?php echo base_url();?>orders/history" method="get">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-2" style="text-align:center;padding-top:5px">
                      ...
                      <a href="<?php echo base_url();?>orders/history"class="btn btn-primary">RESET</a>
                    </div>
                  </div>
                  <!-- search filters -->
                              ...
                              <table id="example" class="table table-striped table-bordered zero-configuration">
                                ...
                                <tbody>
                                  <?php if(!empty($order['_products'])) {
                                    ...
                                    echo "</tr>";
                                    echo "<tr style='text-align:center'>";
                                      echo "<td>TOTAL AMOUNT CUSTOMER PAID</td>";
                                      echo "<td colspan=2>";
