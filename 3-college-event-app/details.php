              ...
              <div class="grid_7">
                  ...
                  <div class="blog">
                      ...
                      if(isset($_GET['id']))
                      {
                        $post_id = $_GET['id'];
                          ...
                          $query = mysqli_query($mysqli,"select * from posts where id='$post_id' order by 1 DESC");
                  ...
                  <div class="grid_4 preffix_1">
                    <h2>Recent Posts</h2>
                       ...
                       <?php 
                        $query = mysqli_query($mysqli,"select * from posts where status='1' order by 1 DESC LIMIT 0,3");
