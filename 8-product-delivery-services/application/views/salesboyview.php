    ...
    <div class="content-body">
      <div class="container-fluid" style="padding: 0.5rem 0.5rem;">
        <div class="row">
          ...
          <a href="<?php echo base_url(); ?>index.php/salesboys" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Go Back</a>&nbsp&nbsp
          <button class="btn btn-primary"><?php echo "Sales Boy: ".$user['name']; ?></button>&nbsp&nbsp
          <button class="btn btn-primary"><?php echo "Mobile: ".$user['mobile']; ?></button>&nbsp&nbsp
          <button class="btn btn-primary">Complete Sales Boy Overview</button>
          <!-- Heading -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body" style="padding: 0.5rem 0.5rem;">
                ...
                <!-- Search form -->
                <form action="<?php echo base_url();?>index.php/salesboy/view/<?php echo $user['uuid']; ?>" method="get">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3" style="text-align:center;margin-top:25px">
                      ...
                      <a href="<?php echo base_url();?>index.php/salsboy/view/<?php echo $user['uuid']; ?>"class="btn btn-primary">RESET</a>
                    </div>
                  </div>
                  <!-- search filters -->
              ...
              <div class="card">
                <div class="card-body" style="padding: 0.5rem 0.5rem;">
                  ...
                  <div class="card mb-4 wow fadeIn" style="margin-bottom: 0rem !important;">
                    ...
                    <b>ORDERS OVERVIEW
                      <?php if($this->input->get('order_from')) { ?>
                        FROM <?php echo $this->input->get('order_from'); ?>
                      <?php } ?>
                      <?php if($this->input->get('order_to')) { ?>
                        TO <?php echo $this->input->get('order_to'); ?>
                      <?php } ?>
                    </b>
                    </h2>
                  </div>
                  ...
                  <table class="table table-striped table-bordered table-hover" width="100%" cellspacing="0">
                    <tbody>
                      <tr style='text-align:center'>
                        <td colspan=2>Total Orders Delivered</td>
                        <td colspan=2><?php echo $statistics['total_orders']; ?></td>
                      </tr>
                      <tr style='text-align:center'>
                        <td style="color:green;"><b>TOTAL AMOUNT COLLECTED FROM CUSTOMERS</b></td>
                        <td style="color:green;"><b><?php echo $statistics['total_selling_price']; ?></b></td>
                      </tr>
                    </tbody>
                  </table>
                  <!-- Overview-->
