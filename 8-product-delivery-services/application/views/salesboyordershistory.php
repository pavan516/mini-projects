          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body" style="padding: 0.5rem 0.5rem;">
                ...
                <!-- Search form -->
                <form action="<?php echo base_url();?>index.php/salesboy/orders/history" method="get">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3" style="text-align:center;margin-top:25px">
                      ...
                      <a href="<?php echo base_url();?>index.php/salesboy/orders/history"class="btn btn-primary">RESET</a>
                    </div>
                  </div>
                  <!-- search filters -->
                  ...
                  <table class="table table-striped table-bordered table-hover" width="100%" cellspacing="0">
                    <tbody>
                      <tr style='text-align:center'>
                        ...
                        <td><?php echo $statistics['total_orders']; ?></td>
                      </tr>
                      <tr style='text-align:center'>
