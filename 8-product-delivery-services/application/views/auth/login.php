<!DOCTYPE html>
  ...
  <head>
    ...
    <!-- Title -->
    <title itemprop="name">LOGIN - DELIVERY SERVICES</title>
            ...
            <div class="form-input-content">
              <div class="card login-form mb-0">
                <div class="card-body pt-5">
                  ...
                  <!-- Form -->
                  <form class="mt-5 mb-5 login-input" action="<?php echo base_url();?>index.php/auth/login/user" method="POST" enctype="multipart/form-data">
                  ...
                  <p class="mt-5 login-form__footer">
                    Not Yet Registered? <a href="<?php echo base_url();?>index.php/auth/register" class="text-primary"><b>Register Here</b></a>
                    | Fogot Password ? <a href="<?php echo base_url();?>index.php/auth/forgotpassword" class="text-primary"><b>Reset Here</b></a>
                  </p>
