<!DOCTYPE html>
  ...
  <head>
    ...
    <!-- Title -->
    <title itemprop="name">RESET PASSWORD - DELIVERY SERVICES</title>
            ...
            <div class="form-input-content">
              <div class="card login-form mb-0">
                <div class="card-body pt-5">
                  ...
                  <!-- Form -->
                  <form class="mt-5 mb-5 login-input" action="<?php echo base_url();?>index.php/auth/resetpassword" method="POST">
                    <div class="form-group">
                      <input type="hidden" name="mobile" value="<?php echo $mobile; ?>">
                      <input type="hidden" name="otp" value="<?php echo $otp; ?>">
                      <input type="text" class="form-control" name="user_otp" placeholder="OTP" required>
