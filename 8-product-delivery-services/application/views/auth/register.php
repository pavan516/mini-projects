<!DOCTYPE html>
  ...
  <head>
    ...
    <!-- Title -->
    <title itemprop="name">REGISTRATION - DELIVERY SERVICES</title>
    ...
    <meta name="description" content="Delivery Services is a online & offline delivery service. we do all delivery & services as per user requests such as delivering vegetables, glocerious, medicines, fruits, alcohol, food, sweets & etc.. also we service all types of works such as car wash, bike wash, home cleanup, functions video coverages, vehicle repair & etc..." />
    <meta name="keywords" content="delivery services, delivery, services, delivery & services, online services, online delivery, offline delivery, offline services, vegitables, gloceries, medicines, fruits, alcohol, food, sweets, car wash, bike wash, home cleanup, functions, studio, vehicle repairs, alcohol deliver, biryani" /> 
            ...
            <div class="form-input-content">
              <div class="card login-form mb-0">
                <div class="card-body pt-5">
                  ...
                  <!-- Form -->
                  <form class="mt-5 mb-5 login-input" action="<?php echo base_url();?>index.php/auth/insert/user" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control" name="password" placeholder="Password - must contain 6 characters" required>
                    </div>
                  ...
                  <p class="mt-5 login-form__footer">
                    Already Have account? | <a href="<?php echo base_url();?>index.php/auth/login" class="text-primary"><b>Sign In Here</b></a></p>
                  </p>
