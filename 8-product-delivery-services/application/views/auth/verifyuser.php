<!DOCTYPE html>
  ...
  <head>
    ...
    <!-- Title -->
    <title itemprop="name">VERIFICATION - DELIVERY SERVICES</title>
            ...
            <div class="form-input-content">
              <div class="card login-form mb-0">
                <div class="card-body pt-5">
                  ...
                  <!-- Form -->
                  <form class="mt-5 mb-5 login-input" action="<?php echo base_url();?>index.php/auth/verify/user" method="POST">
