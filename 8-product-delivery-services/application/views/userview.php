    ...
    <div class="content-body">
      <div class="container-fluid" style="padding: 0.5rem 0.5rem;">
        <div class="row">
          ...
          <a href="<?php echo base_url(); ?>index.php/users" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Go Back</a>&nbsp&nbsp
          <button class="btn btn-primary"><?php echo "User: ".$user['name']; ?></button>&nbsp&nbsp
          <button class="btn btn-primary"><?php echo "Mobile: ".$user['mobile']; ?></button>&nbsp&nbsp
          <button class="btn btn-primary">Complete User Overview</button>
          <!-- Heading -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body" style="padding: 0.5rem 0.5rem;">
                ...
                <!-- Search form -->
                <form action="<?php echo base_url();?>index.php/user/view/<?php echo $user['uuid']; ?>" method="get">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3" style="text-align:center;margin-top:25px">
                      ...
                      <a href="<?php echo base_url();?>index.php/user/view/<?php echo $user['uuid']; ?>"class="btn btn-primary">RESET</a>
                    </div>
                  </div>
                  <!-- search filters -->
