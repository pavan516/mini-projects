      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body" style="padding-bottom:0px;">
            <!-- Form -->
            <form action="<?php echo base_url();?>notes" method="get">
              <!-- Select Date -->
        ...
        <div class="row mb-4 wow fadeIn">
          ...
          if(!empty($items)) {
              ...
              <div class="col-lg-4 col-md-12 mb-4">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <!-- Description -->
                    <!-- Read more link -->
                    <a href="<?php echo base_url();?>note/<?php echo $item['uuid']; ?>" class="btn btn-primary btn-md">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">NO NOTES UPLOADED</h4>
                </div>
              </div>
            </div>
          <?php } ?>
