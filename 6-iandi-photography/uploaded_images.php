        ...
        <ul class="portfolio-items col-3">
                            ...
                            <li class="portfolio-item apps">
                                <div class="item-inner">
                                    ...
                                    <div class="overlay">
                                        <a class="preview btn btn-danger" <?php echo "href='post_long_images/$post_long_image'"; ?> rel="prettyPhoto"><i class="icon-eye-open"></i></a>             
                                        <a href="delete.php?post_id=<?php echo $post_id ?>">delete</a>
