...
<div id="wrap">
		...
		<div id="useractions">
			...
			<div id="login">
				<div id="loginform">
						...
						<h1 style="color:blue;font-size:300%;" align="center">Online Home Service</h1>					
	...
	<div id="header">
		<div id="sitename" id="shoutout" align='left'><br><br><br>
			<br>
		</div>
		<div id="shoutout">
			<br>
				...
				<!-- LOGIN WORK -->
					...
					<form action="" method="post">
						...
						<div class="formblock">
							...
							<input name="user_pass" id="user_pass" type="password" class="textfields"/>
						</div>
						<br>
						<div class="formblock">
	...
	<div id="content">
	    ...
	    <div id="sidebar">
			<div class="block"><a href="https://www.flipkart.com/"><img src="admin/image.jpg" width="1400" height="400"/></a></div>
		</div>
		<div class="clear">&nbsp;</div>
