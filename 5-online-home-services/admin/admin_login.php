				...
				<div id="loginform">
					...
					<form action="" method="post">
						...
						<div class="formblock">
							...
							<input name="admin_email" id="admin_email" type="text" class="textfields" />
						</div>
						
						<div class="formblock">
							<label>Admin Password</label>
							<input name="admin_pass" id="admin_pass" type="text" class="textfields"/>
						</div>
						<br>
						<div class="formblock">
							<button><button><input type="submit" name="admin_login" id="admin_login" value="Login" /></button></button>
						</div>
					...
					<?php
                        ...
                        if(isset($_POST['admin_login']))
                        {
	                        ...
	                        if($check==1)
	                        {
								...
								echo "<script>alert('Welcome To Online Home Service Admin Panel')</script>";								
